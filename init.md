...
WriteTrack is a web app that helps a writer track his work, progress, draft, ideas, writer assistant, research, etc.

For the tech stack we choose: nodejs, TypeScript, with SvelteKit, TailwindCSS in the frontend and Supabase in the backend.
For AI we will use Vercel AI SDK. OpenAI, Anthropic, Google Gemini API keys can be set as environment variables.

Here’s a concrete feature set you could build around that use case. Think of it as modules you can prioritize.
